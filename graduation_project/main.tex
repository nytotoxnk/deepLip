...
In 2023, the company Niv-Al released "Peshperima," a model based on OpenAI's Whisper. This model was later improved and made closed-source, offering it as a paid service. As a student, I was granted access to use and experiment with the model for a limited time. Although no confidence score for transcriptions, a SRT file was available upon succesfull finish.
